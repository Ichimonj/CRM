...
void Company::setCompanyName(const std::string& company_name, const InternalEmployeePtr& changer)
{
...
void Company::setLegalName(const OptionalStr& legal_name, const InternalEmployeePtr& changer)
{
...
void Company::setWebsiteUrl(const OptionalStr& website_url, const InternalEmployeePtr& changer)
{
...
void Company::setPhoneNumber(const PhoneNumberPtr& phone_number, const InternalEmployeePtr& changer)
{
...
void Company::setEmail(const OptionalStr& email, const InternalEmployeePtr& changer)
{
    if (this->email != email) {
        this->change_logs.emplace_back(std::make_shared<ChangeLog>(
            changer,
...
void Company::setRegisteredAddress(
...
void Company::setAnnualRevenue(const MoneyPtr& annual_revenue, const InternalEmployeePtr& changer)
{
...
void Company::addNote(const Note& note, const InternalEmployeePtr& changer)
{
...
void Company::delNote(size_t index, const InternalEmployeePtr& changer)
{
...
void Company::addMorePhoneNumber(
...
void Company::delMorePhoneNumber(size_t index, const InternalEmployeePtr& changer)
{
...
void Company::addMoreEmail(const std::string& email, const InternalEmployeePtr& changer)
{
...
void Company::delMoreEmail(size_t index, const InternalEmployeePtr& changer)
{
...
void Company::setIndustry(const OptionalStr& industry, const InternalEmployeePtr& changer)
{
...
void Company::setCountryCode(const OptionalStr& country_code, const InternalEmployeePtr& changer)
{
...
void Company::setFoundedDate(const DatePtr& founded_date, const InternalEmployeePtr& changer)
{
...
void Company::setTaxId(const OptionalStr& tax_id, const InternalEmployeePtr& changer)
{
...
void Company::setBudget(const MoneyPtr& budget, const InternalEmployeePtr& changer)
{
...
void Company::addTaxRate(const TaxInfo& tax_rate, const InternalEmployeePtr& changer)
{
...
void Company::delTaxRate(size_t index, const InternalEmployeePtr& changer)
{
...
void Company::addDeal(const DealPtr& deal, const InternalEmployeePtr& changer)
{
...
void Company::delDeal(size_t index, const InternalEmployeePtr& changer)
{
...
void Company::addTask(const TaskPtr& task, const InternalEmployeePtr& changer)
{
...
void Company::delTask(size_t index, const InternalEmployeePtr& changer)
{
